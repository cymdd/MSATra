...
def get_parser():
    parser = argparse.ArgumentParser(description='MSATra')
    ...
    parser.add_argument('--num_heads', type=int, default=8, help='Head number of multihead_attention')
